...
def main():
    ...
    better_draw_circles(5,  rg.Point(0, 0))
    better_draw_circles(5, rg.Point(200, 0))
    even_better_draw_circles(rg.Point(0, 0), 20, 100, 'midnight blue', 10)
    window.update()
...
def better_draw_circles(x,  point):
    """
...
def even_better_draw_circles(point, amount_vary,    number_of_circle,   color,  thickness):
    ...
    for k in range(number_of_circle):
        turtle.pen_up()
        turtle.right(90)
        turtle.forward(amount_vary)
        turtle.left(90)
        turtle.pen_down()
        turtle.pen= rg.Pen(color,   thickness)
        turtle.draw_circle(amount_vary * k)
